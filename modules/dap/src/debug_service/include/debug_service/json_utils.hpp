...
///
/// \param[in] request
///     The request object received from a call to DebugService::ReadJSON().
///
...
///
/// \param[in] dap
///     The DebugService session associated with the stopped thread.
///
/// \param[in] thread
...
/// a canonical set of properties that can be sent to DebugService clients.
