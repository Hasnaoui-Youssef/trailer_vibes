...
#include "common/output_redirector.hpp"
...
// Was `dap::OutputBufferSize` - duplicated locally now that
// this file has no dependency on the debug_service module.
static constexpr uint64_t OutputBufferSize = (1u << 12);
