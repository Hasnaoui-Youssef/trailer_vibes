...
namespace {
// Local equivalent of dap::JSONToString - kept here rather than depending on
// the dap module, so `common` has no dependency on anything above it.
